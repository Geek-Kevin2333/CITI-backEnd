...
public class PermissionController {
	...
	public ResultVO<Boolean> save(@RequestBody Permission permission){
		...
		else return new ResultVO<Boolean>(StatusCode.BAD_REQUEST,permission.getComment()+"插入失败",false);
	}
	...
	public ResultVO<Boolean> update(@RequestBody Permission permission){
		...
		else return new ResultVO<Boolean>(StatusCode.BAD_REQUEST,permission.getComment()+"更新失败",false);
	}
	...
	public ResultVO<Boolean> delete(@PathVariable Integer id){
		...
		else return new ResultVO<Boolean>(StatusCode.BAD_REQUEST,"删除失败",false);
	}
	...
	public ResultVO<Permission> getById(@PathVariable Integer id){
		...
		else return new ResultVO<Permission>(StatusCode.BAD_REQUEST,"查找失败",null);
	}
	...
	public ResultVO<List<Permission>> getAll(){
		...
		else return new ResultVO<List<Permission>>(StatusCode.BAD_REQUEST,"查找失败",null);
	}
}
